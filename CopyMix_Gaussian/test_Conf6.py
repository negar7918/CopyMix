...
data_sign[:len(new_Y1),100:200] = np.array([rng.normal(loc=mean, scale=math.sqrt(.1), size=100) for mean in means])

plot(seq_len, data_sign, "CONF 6")
...
c = calculate_predicted_c(new_pi, new_weight_vertex, "CONF 6")
print(c[0])
print('#####')
print(c[1])
